...
class ApiService {
  ...
  async setCoverImage(hostelId: string, imageUrl: string) {
    const response = await this.api.put(
      `/owner/hostels/${hostelId}/cover-image`,
      { imageUrl },
    );
    return response.data;
  }
  ...
  async updateHostelAmenities(hostelId: string, amenities: string[]) {
    const response = await this.api.put(
      `/owner/hostels/${hostelId}/amenities`,
      { amenities },
    );
    return response.data;
  }
  ...
  async getAnalytics(
    type: "attendance" | "violations" | "discipline",
    params?: any,
  ) {
  ...
  async getOccupancyReport(params?: any) {
    const response = await this.api.get("/owner/analytics/occupancy", {
      params,
    });
    return response.data;
  }
  ...
  async getFinancialReport(params?: any) {
    const response = await this.api.get("/owner/analytics/financial", {
      params,
    });
    return response.data;
  }
  ...
  async getFeeStructures(hostelId: string) {
    const response = await this.api.get(
      `/owner/hostels/${hostelId}/fee-structure`,
    );
    return response.data;
  }
  ...
  async getOwnerNotifications(hostelId: string) {
    const response = await this.api.get(
      `/owner/hostels/${hostelId}/notifications`,
    );
    return response.data;
  }
  ...
  async approveOwnerVisitorRequest(visitorId: string) {
    const response = await this.api.post(
      `/owner/visitors/${visitorId}/approve`,
    );
    return response.data;
  }
  ...
  async rejectOwnerVisitorRequest(visitorId: string, rejectionReason: string) {
    const response = await this.api.post(
      `/owner/visitors/${visitorId}/reject`,
      { rejectionReason },
    );
    return response.data;
  }
  ...
  async createMessSchedule(
    ...
    const response = await this.api.post(
      `/owner/hostels/${hostelId}/mess`,
      data,
    );
    return response.data;
  }

  async updateMessSchedule(
    hostelId: string,
    scheduleId: string,
    data: Partial<{
      mealType: string;
    ...
    const response = await this.api.put(
      `/owner/hostels/${hostelId}/mess/${scheduleId}`,
      data,
    );
    return response.data;
  }
  ...
  async approveStudentOnboarding(studentId: string) {
    const response = await this.api.post(
      `/owner/students/${studentId}/approve`,
    );
    return response.data;
  }

  async updateStudentStatus(studentId: string, status: string) {
    const response = await this.api.put(`/owner/students/${studentId}/status`, {
      status,
    });
    return response.data;
  }
  ...
  async getRules(params?: any) {
    const p = typeof params === "string" ? { hostelId: params } : params;
    const response = await this.api.get("/owner/rules", { params: p });
    return response.data;
  }
  ...
  async triggerAttendanceCheck(hostelId: string) {
    const response = await this.api.post("/owner/attendance/check", {
      hostelId,
    });
    return response.data;
  }
  ...
  async getStudentLocations(params?: any) {
    const response = await this.api.get("/owner/students/locations", {
      params,
    });
    return response.data;
  }
  ...
  async getLocationPermissionStatus(hostelId?: string) {
    const response = await this.api.get(
      "/owner/students/location-permissions",
      { params: { hostelId } },
    );
    return response.data;
  }
  ...
  async getStudentsWithAttendance(hostelId?: string) {
    ...
    const response = await this.api.get("/owner/students/with-attendance", {
      params,
    });
    const body = response.data as { success?: boolean; data?: any[] };
    return body?.data ?? [];
  ...
  async approveLeaveRequest(permissionId: string) {
    const response = await this.api.post(
      `/owner/leave-requests/${permissionId}/approve`,
    );
    return response.data;
  }
  ...
  async rejectLeaveRequest(permissionId: string, rejectionReason?: string) {
    const response = await this.api.post(
      `/owner/leave-requests/${permissionId}/reject`,
      { rejectionReason },
    );
    return response.data;
  }
  ...
  async updateComplaintStatus(
    ...
    const response = await this.api.put(
      `/owner/complaints/${complaintId}/status`,
  ...
  async getDashboard(hostelId?: string) {
    const response = await this.api.get("/warden/dashboard", {
      params: { hostelId },
    });
    return response.data;
  }
  ...
  async approvePermission(permissionId: string) {
    const response = await this.api.post(
      `/warden/permissions/${permissionId}/approve`,
    );
    return response.data;
  }
  ...
  async rejectPermission(permissionId: string, reason: string) {
    const response = await this.api.post(
      `/warden/permissions/${permissionId}/reject`,
  ...
  async approveVisitor(visitorId: string) {
    const response = await this.api.post(
      `/warden/visitors/${visitorId}/approve`,
    );
    return response.data;
  }
  ...
  async getAttendanceAnalytics(
    period: "daily" | "week" | "month" | "year" = "week",
  ) {
  ...
  async getHostelBoundary() {
    ...
    const body = response.data as { success?: boolean; data?: any };
    if (!body?.success || !body?.data)
      throw new Error("Failed to load hostel boundary");
    return body.data;
  }
  ...
  async updateLocation(
    ...
    const acc = accuracy != null ? accuracy : location?.accuracy;
    const ts = timestamp
    ...
    const response = await this.api.post("/student/location/update", payload);
    return response.data;
  }
  ...
  async updateLocationPermission(
    ...
    const response = await this.api.put("/student/location/permission", {
      status,
    });
    return response.data;
  }
  ...
  async registerExpoPushToken(expoPushToken: string) {
    const response = await this.api.post("/student/expo-push-token", {
      expoPushToken,
    });
    return response.data;
  }
  ...
  async cancelPermissionRequest(permissionId: string) {
    const response = await this.api.post(
      `/student/permissions/${permissionId}/cancel`,
    );
    return response.data;
  }
  ...
  async dismissNotification(notificationId: string) {
    const response = await this.api.post(
      `/student/notifications/${notificationId}/dismiss`,
    );
    return response.data;
  }
  ...
  async createRazorpayOrderForPayment(paymentId: string) {
    const response = await this.api.post(
      `/student/payments/${paymentId}/create-order`,
    );
    return response.data;
  }
  ...
  async updateTaskStatus(taskId: string, status: string) {
    const response = await this.api.put(`/cleaner/tasks/${taskId}/status`, {
      status,
    });
    return response.data;
  }
  ...
  async updateComplaintStatusCleaner(
    complaintId: string,
    status: string,
    notes?: string,
  ) {
    const response = await this.api.put(
      `/cleaner/complaints/${complaintId}/status`,
