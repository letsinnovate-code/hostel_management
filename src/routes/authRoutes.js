...
const { register, login, getMe, setCurrentRole, registerStudentViaQR, changePassword, logoutAll } = require('../controllers/authController');
const { protect } = require('../middleware/auth');

// Brute-force protection for login: max 15 requests per 15 minutes per IP (disabled in test)
...
// Registration rate limit: max 20 registrations per hour per IP (disabled in test)
