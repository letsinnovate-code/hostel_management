...
async function logGateEvent(opts) {
  ...
  try {
    ...
    // Socket broadcast errors do not invalidate database persistence of gate events
    console.warn('[gateEventService] Socket broadcast failed for gate event:', socketErr.message);
  }
}
